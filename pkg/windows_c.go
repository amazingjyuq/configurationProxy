...
func WindowsSetProxySettings(proxyServer string) error {
	// 设置代理服务器和端口
...
func WindowsEnableProxySettings() error {
	// 启用代理
...
func WindowsDisableProxySettings() error {
	// 禁用代理
...
func WindowsGetProxySettings() (string, uint32, uint32, error) {
	// 读取代理设置
